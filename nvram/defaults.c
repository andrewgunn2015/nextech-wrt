...
//!	{ "wan_ifnames",		""				},	// WAN interface names
	...
	{ "wl_bcn",				"75"			},	// Beacon interval
	{ "wl_plcphdr",			"long"			},	// 802.11b PLCP preamble type
	{ "wl_net_mode",		"disable"			},	// Wireless mode (mixed|g-only|b-only|disable)
	{ "wl_gmode",			"1"				},	// 54g mode
...
// admin-access
	...
	{ "remote_mgt_https",	"1"				},	// Remote Management use https [1|0]
