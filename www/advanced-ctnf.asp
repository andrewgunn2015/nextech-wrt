...
<table style="WIDTH: 100%; HEIGHT: 100%" cellSpacing="0" cellPadding="0" border="0">
  ...
  onmouseover="javascript:StopSlideShow();" onMouseOut="javascript:StartSlideShow();">
          ...
          <td id="ContentRightCell" valign="Top" style="WIDTH: 164px; HEIGHT: 100%"><div id="RightColumn">
            ...
            <p> Lists number of current  port connections</p>
            <p> Sets wait times for  TCP messages</p>
            <p> Sets wait times for  UDP messages</p>
            <p> Will automatically open connections for the following services if checked.</p>
            <p> Sets Time to Live  parameters.</p>
          </div></td>
        </tr>
      </table></td>
  </tr>
