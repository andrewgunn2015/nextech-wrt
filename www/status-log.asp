...
<table style="WIDTH: 100%; HEIGHT: 100%" cellSpacing="0" cellPadding="0" border="0">
  ...
  onmouseover="javascript:StopSlideShow();" onMouseOut="javascript:StartSlideShow();">
          ...
          <td id="ContentRightCell" valign="Top" style="WIDTH: 164px; HEIGHT: 100%"><div id="RightColumn">
            ...
            <p> Click a link to show the desired number of log entries you wish to view.</p>
            <p> Click on Download  Log File to display entire log for downloading, or click on find to search the log by keyword.</p>
            <p> Click on Logging Configuration to configure how the router logs its information.</p>
          </div></td>
        </tr>
      </table></td>
  </tr>
