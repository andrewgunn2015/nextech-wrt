...
<table style="WIDTH: 100%; HEIGHT: 100%" cellSpacing="0" cellPadding="0" border="0">
  ...
  onmouseover="javascript:StopSlideShow();" onMouseOut="javascript:StartSlideShow();">
                ...
                <td><table width="90%">
                    <tr>
                      <td valign="top" align="left" style="padding-left: 10px;">
						...
						<h3>Who is Nex-Tech</h3>
                        <P><FONT face=Verdana size=2>Nex-Tech is a subsidiary of Rural Telephone, a leader in the telecommunications industry since 1951. The goal of Nex-Tech is to provide the highest quality service possible to our customers at affordable prices.</FONT></P>
                        <P><FONT face=Verdana size=2>Our partnership commitment to our customers is keeping you up-to-date with advances in technology and working together with you to provide the best opportunity for your success.</FONT></P>
                        <P><FONT face=Verdana size=2>Rural Telephone and Nex-Tech have provided services for 50 years. Through the Power of One, Nex-Tech keeps you in touch with the latest technology available.</FONT></P>
          ...
          <td id="ContentRightCell" valign="Top" style="WIDTH: 164px; HEIGHT: 100%"><div id="RightColumn"></div></td>
        </tr>
      </table></td>
  </tr>
  <tr id="FooterRow">
