...
<input type='hidden' name='_nextpage' value='index2.asp'>
...
createFieldTable('', [
	...
	{ title: 'Type', name: 'wan_proto', type: 'select', options: [['dhcp','DHCP'],['pppoe','PPPoE'],['static','Static']],
...
f = [
	...
	{ title: 'Security', name: 'security_mode2', type: 'select',
		options: [['disabled','Disabled'],['wep','WEP'],['wpa_personal','WPA Personal'],['wpa2_personal','WPA2 Personal'],['wpaX_personal','WPA / WPA2 Personal']],
